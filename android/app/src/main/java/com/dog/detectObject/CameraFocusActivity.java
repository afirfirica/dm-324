...
public class CameraFocusActivity extends Activity implements SurfaceHolder.Callback, SensorEventListener 
{
    ...
    public void onCreate(Bundle icicle) 
    {
		...
		// Self Change
		preview = (FrameLayout) findViewById(R.id.surface);
        surfaceView = new SurfaceView(this); // (SurfaceView) findViewById(R.id.surface);
    ...
    protected void onUserLeaveHint() 
    {
    	try 
    	{
    		Log.v("on user leave hint", "on userlevve hint pressesd");
    		wl.release();
    	}
    	catch(Exception ex)
    	{
